...
# This one compares the distance to the true minimizer
...
# python bayesian_logreg.py --num_inits=200 --beta=1 --stepsize=0.05 --sample_iters=25 --n_iters=5000 --problem_dim=2 --logistic_samples=50 --alpha=0.5
# python bayesian_logreg.py --num_inits=200 --beta=1 --stepsize=0.05 --sample_iters=25 --n_iters=10000 --problem_dim=2 --logistic_samples=50 --alpha=0.1

# For paper
# python bayesian_logreg_TM.py --num_inits=1000 --beta=1 --stepsize=0.05 --sample_iters=25 --n_iters=4000 --problem_dim=2 --logistic_samples=50 --alpha=0.1
# python bayesian_logreg_TM.py --num_inits=1000 --beta=1 --stepsize=0.05 --sample_iters=25 --n_iters=4000 --problem_dim=2 --logistic_samples=50 --alpha=0.5
# python bayesian_logreg_TM.py --num_inits=1000 --beta=1 --stepsize=0.01 --sample_iters=25 --n_iters=4000 --problem_dim=2 --logistic_samples=50 --alpha=0.1
...
parser.add_argument('--test_fn', type=str, default="logreg_tm")
...
alpha = hparams.alpha
logi_data_path = os.path.join("data", "logreg_TM")
...
# compute true minimzer
#%%
theta_true = np.asarray([[1,1]])
# perform 3000 GD
for i in range(1000):
    theta_true = theta_true - 0.001 * grad_logreg(theta_true)
for i in range(1000):
    theta_true = theta_true - 0.0001 * grad_logreg(theta_true)

print(theta_true)
#%%
def theta_err(theta):
    return np.mean(np.abs(theta-theta_true))

def theta_err2(theta):
    return np.mean(np.abs(np.mean(theta, axis=0)-theta_true))

if TEST_FN == "logreg_tm":
    V = logreg
    dV = grad_logreg
