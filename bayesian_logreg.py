...
# For paper
# python bayesian_logreg.py --num_inits=1000 --beta=1 --stepsize=0.05 --sample_iters=25 --n_iters=4000 --problem_dim=2 --logistic_samples=50 --alpha=0.1
# python bayesian_logreg.py --num_inits=1000 --beta=1 --stepsize=0.01 --sample_iters=25 --n_iters=4000 --problem_dim=2 --logistic_samples=50 --alpha=0.1
